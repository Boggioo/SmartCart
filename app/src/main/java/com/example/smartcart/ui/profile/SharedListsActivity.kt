                ...
                RetrofitClient.api().deleteList(token, listId).enqueue(object : Callback<Map<String, Any>> {
                    override fun onResponse(call: Call<Map<String, Any>>, response: Response<Map<String, Any>>) {
                        ...
                        if (response.isSuccessful) {
                            ...
                            Toast.makeText(this@SharedListsActivity, "Lista eliminata con successo", Toast.LENGTH_SHORT).show()
                            ...
                            Toast.makeText(this@SharedListsActivity, "Errore nell'eliminazione della lista", Toast.LENGTH_SHORT).show()
                        }
                    }
